...
`;function q({columns:t=[],conditionalRowStyles:n=[],defaultExpanded:o=!1,defaultExpanderDisabled:a=!1,dense:l=!1,expandableIcon:i,expandableRows:s=!1,expandableRowsComponent:d,expandableRowsComponentProps:c,expandableRowsHideExpander:g,expandOnRowClicked:u=!1,expandOnRowDoubleClicked:m=!1,highlightOnHover:h=!1,id:f,expandableInheritConditionalStyles:x,keyField:C,onRowClicked:y=p,onRowDoubleClicked:v=p,onRowMouseEnter:R=p,onRowMouseLeave:S=p,onRowExpandToggled:E=p,onSelectedRow:O=p,pointerOnHover:P=!1,row:k,rowCount:D,rowIndex:H,selectableRowDisabled:$=null,selectableRows:I=!1,selectableRowsComponent:j,selectableRowsComponentProps:L,selectableRowsHighlight:M=!1,selectableRowsSingle:A=!1,selected:N,striped:W=!1,draggingColumnId:B,onDragStart:G,onDragOver:V,onDragEnd:U,onDragEnter:Y,onDragLeave:q}){const[J,Q]=e.useState(o);e.useEffect((()=>{Q(o)}),[o]);const X=e.useCallback((()=>{Q(!J),E(!J,k)}),[J,E,k]),Z=P||s&&(u||m),ee=e.useCallback((e=>{e.target&&"allowRowEvents"===e.target.getAttribute("data-tag")&&(y(k,e),!a&&s&&u&&X())}),[a,u,s,X,y,k]),te=e.useCallback((e=>{e.target&&"allowRowEvents"===e.target.getAttribute("data-tag")&&(v(k,e),!a&&s&&m&&X())}),[a,m,s,X,v,k]),ne=e.useCallback((e=>{R(k,e)}),[R,k]),oe=e.useCallback((e=>{S(k,e)}),[S,k]),ae=r(k,C),{style:le,classNames:re}=b(k,n,["rdt_TableRow"]),ie=M&&N,se=x?le:{},de=W&&H%2==0;return e.createElement(e.Fragment,null,e.createElement(K,{id:`row-${f}`,role:"row",striped:de,highlightOnHover:h,pointerOnHover:!a&&Z,dense:l,onClick:ee,onDoubleClick:te,onMouseEnter:ne,onMouseLeave:oe,className:re,selected:ie,style:le},I&&e.createElement(T,{name:`select-row-${ae}`,keyField:C,row:k,rowCount:D,selected:N,selectableRowsComponent:j,selectableRowsComponentProps:L,selectableRowDisabled:$,selectableRowsSingle:A,onSelectedRow:O}),s&&!g&&e.createElement(_,{id:ae,expandableIcon:i,expanded:J,row:k,onToggled:X,disabled:a}),t.map((t=>t.omit?null:e.createElement(F,{id:`cell-${t.id}-${ae}`,key:`cell-${t.id}-${ae}`,dataTag:t.ignoreRowClick||t.button?null:"allowRowEvents",column:t,row:k,rowIndex:H,isDragging:w(B,t.id),onDragStart:G,onDragOver:V,onDragEnd:U,onDragEnter:Y,onDragLeave:q})))),s&&J&&e.createElement(z,{key:`expander-${ae}`,data:k,extendedRowStyle:se,extendedClassNames:re,ExpanderComponent:d,expanderComponentProps:c}))}const J=n.span`
	padding: 2px;
	color: inherit;
	flex-grow: 0;
	flex-shrink: 0;
